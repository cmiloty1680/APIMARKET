...
function WelcomeSection() {
  const modules = [
    { name: "Colmena", href: "/dashboard/hive", icon: <  Hexagon size={24} /> },
    { name: "Producción", href: "/dashboard/production", icon: <Droplet size={24} /> },
    { name: "Recolección de Miel", href: "/dashboard/recolection", icon: <Flask size={24} /> },
    { name: "Protocolo", href: "/dashboard/protocol", icon: <Clipboard size={24} /> },
    { name: "Alimentación", href: "/dashboard/feeding", icon: <Flower size={24} /> },
    ...
    { name: "Inseminación", href: "/dashboard/insemination", icon: <Sprout size={24} /> },
