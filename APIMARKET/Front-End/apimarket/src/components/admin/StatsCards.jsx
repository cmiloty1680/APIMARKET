          ...
          <div className="bg-white backdrop-blur-xl bg-opacity-80 p-6 rounded-2xl shadow-lg border border-white/20 overflow-hidden relative group">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-end justify-between">
                <p className="text-3xl font-bold text-slate-800">{totColm}</p>
              ...
              <div className="flex justify-between items-center mt-2">
                <div className="flex items-center">
                  ...
                  <span className="text-xs text-slate-500">Total: {totColm}</span>
                </div>
          ...
          <div className="bg-white backdrop-blur-xl bg-opacity-80 p-6 rounded-2xl shadow-lg border border-white/20 overflow-hidden relative group">
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-1">
                ...
                <h3 className="text-sm font-medium text-slate-500">Recolección de Miel</h3>
              </div>
              <div className="flex items-end justify-between">
