...
// // import ExportToPDFDialog from "./ExportToPDFDialog"; // Importamos el componente ExportToPDFDialog

// function ContentPage({ TitlePage, Data, TitlesTable, Actions, updateTextTitleForm, openModalForm, ignorar , setIsExportModalOpen}) {
...
//           onClick={() => setIsExportModalOpen(true)} // Abre el modal
//         >
//           Exportar
//         </Button>

//         {/* Otro botón (Agregar o alguna otra acción) */}
//         <Button
//           className="border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#e87204] hover:bg-[#30712] focus:outline-none"
//           onClick={() => { updateTextTitleForm("Registrar", {}); openModalForm(true); }} // Abre otro modal
//         >
//           Agregar
//         </Button>
//       </div>
