...
function ColmenaRecoleccion() {
  const TitlePage = "Recolección de Zanganos"
  const TitlePages = "Extraciòn de Semen"
  const TitlesPages = "Fertilizaciòn"
  ...
  const [isExportModalOpens, setIsExportModalOpens] = useState(false); // 👈 Para controlar el modal de exportación
  const [isExportModalOpenls, setIsExportModalOpenls] = useState(false); // 👈 Para controlar el modal de exportación
                ...
                <div className="relative p-6">
                  ...
                  {currentView === VIEW_MAIN &&
                    <ContentPage
                      ...
                      tableName="Recolecciòn de zanganos"
