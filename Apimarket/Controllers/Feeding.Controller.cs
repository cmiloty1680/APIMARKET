...
namespace Apimarket.Controllers
{
    ...
    public class FeedingController : ControllerBase
    {
        ...
        public IActionResult AddP([FromBody] Feeding entity)
            ...
            {
                return BadRequest("El Id de alimentacion debe ser un valor positivo");
            }


            var existingFeeding = _feedingServices.GetFeeding(entity.Id_Feeding);
            if(existingFeeding != null)
            {
                return Conflict("ya existe una alimentacion con ese ID");
            }
