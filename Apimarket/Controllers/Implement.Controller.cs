...
namespace Apimarket.Controllers
{
    ...
    public class ImplementController : ControllerBase
    {
        ...
        public IActionResult AddP([FromBody] Implement entity)
        {
            ...
            if (entity.Id_Implement <= 0)
            {
                return BadRequest("El Id de implemento debe ser un valor positivo");
            }


            var existingImplement = _implementServices.GetImplement(entity.Id_Implement);
            if (existingImplement != null)
            {
                return Conflict("ya existe una Implemento con ese ID");
            }
